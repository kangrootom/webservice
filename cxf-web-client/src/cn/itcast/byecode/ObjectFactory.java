 ...
 * generated in the cn.itcast.byecode package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayBye_QNAME = new QName("http://inter.server.itcast.cn/", "sayBye");
    private final static QName _SayByeResponse_QNAME = new QName("http://inter.server.itcast.cn/", "sayByeResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.itcast.byecode
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://inter.server.itcast.cn/", name = "sayBye")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://inter.server.itcast.cn/", name = "sayByeResponse")
